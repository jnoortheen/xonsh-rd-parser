...
use crate::string::{
    parse_interpolated_string_literal_element, parse_string_literal, InterpolatedStringKind,
    StringType,
};
...
impl<'src> Parser<'src> {
    ...
    pub(super) fn parse_atom(&mut self) -> ParsedExpr {
        let start = self.node_start();
    ...
    pub(crate) fn parse_slice(&mut self, close_kind: TokenKind) -> Expr {
